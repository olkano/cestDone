...
export function buildReviewPrompt(phaseNumber: number, phaseName: string, phaseSpec: string, workerReport: string, runDir: string, completedSubPhases: string[] = [], autoCommit: boolean = true): string {
  ...
  parts.push(
    '',
    '## Task',
    'Review the Worker\'s work. You have a limited turn budget. Prioritize the most impactful checks',
    'and respond as soon as you have enough information to make a judgment.',
    'Do not re-verify things the Worker confirmed in its report.',
    '',
